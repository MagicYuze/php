<?php 
	...
	if(isset($_POST['uname'])){
	    ...
	    if($uid == 0){
	    	$res = mysql_query('select * from user order by uid DESC');
       		$uid = mysql_fetch_assoc($res)['uid']+1;
		    $sql = 'INSERT INTO  user (uid,uname,password,phone,email,level,state) VALUES ('.$uid.',"'.$uname.'","'.$password.'","'.$phone.'","'.$email.'",'.$level.',1)';
		    $res = mysql_query($sql);
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								...
								<input type="text" class="span3" id="uname" name="uname" value="<?php echo $uname;?>"/>
							  </div>
							</div>   
							<div class="control-group">
							  <label class="control-label" for="password">用户密码：</label>
							  <div class="controls">
								<input type="text" class="span3" id="password" name="password" value="<?php echo $password;?>"/>
							  </div>
							</div>
							<?php
								if(!$level){
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span3" id="phone" name="phone" value="<?php echo $phone;?>"/>
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="email">邮箱：</label>
							  <div class="controls">
								<input type="text" class="span3" id="email" name="email" value="<?php echo $email;?>"/>
							  </div>
							</div>       
