...
include "checkLogin.php";
	...
	<body>
		...
		<h2><i class="icon-sitemap"></i><span class="break"></span>手机详情</h2>
		</div>
		...
		while ($row = mysql_fetch_assoc($res) ){
			...
			for($i=0;$i<$type_num;$i++){
				...
				<a class="btn btn-info" href="editGoods.php?gid='.$row['gid'].'&type='.$types[$i]['type'].'">
				<i class="icon-edit "></i>  
				</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
